...
class Color(Operation):
    ...
    _operator_ = Literal(string_format='Color', latex_format=r'{\rm Color}', theory=__file__)
...
class MatchingSubset(Operation):
    ...
    _operator_ = Literal(string_format='MatchingSubset', latex_format=r'{\rm MatchingSubset}', theory=__file__)
    
    def __init__(self, sock_set, color):
        self.sock_set = sock_set
        self.color = color
        return Operation.__init__(self, MatchingSubset._operator_, [sock_set, color])        
    ...
    def definition(self):
        ...
        return matching_subset_def.instantiate({S:self.sock_set, color:self.color})
    ...
    def unfold_membership(self, element, assumptions=USE_DEFAULTS):
        ...
        from _common_ import color
        return unfold_matching_subset.instantiate({S:self.sock_set, color:self.color, x:element}, assumptions=assumptions)        
...
class IsMatch(Operation):
    ...
    _operator_ = Literal(string_format='IsMatch', latex_format=r'{\rm IsMatch}', theory=__file__)
    ...
    def definition(self, assumptions=USE_DEFAULTS):
        ...
        return is_match_def.instantiate({a:self.a, b:self.b}, assumptions=assumptions)
...
class ContainsMatch(Operation):
    # operator of the ContainsMatch operation
    _operator_ = Literal(string_format='ContainsMatch', latex_format=r'{\rm ContainsMatch}', theory=__file__)
    ...
    def definition(self, assumptions=USE_DEFAULTS):
        ...
        return contains_match_def.instantiate({S:self.socks}, assumptions=assumptions)

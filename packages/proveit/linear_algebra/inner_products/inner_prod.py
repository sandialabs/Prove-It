...
class InnerProd(Operation):
    ...
    def shallow_simplification(self, *, must_evaluate=False,
        ...
        from proveit.linear_algebra import IsVecSpace, ScalarMult, VecAdd, Hspace, VecNeg
        ...
        _u, _v = self.operands
        try:
            vec_space = IsVecSpace.common_known_vec_space((_u, _v))
        ...
        field = IsVecSpace.known_field(vec_space) #additional line Wayne suggested
    ...
    def deduce_membership(self, field, **defaults_config,):
        ...
        from proveit.linear_algebra import IsInnerProdSpace
        from proveit.numbers import Complex
        _x, _y = self.operands
        yield_spaces = (
                IsInnerProdSpace.yield_readily_provable_inner_prod_spaces)

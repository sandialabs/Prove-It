...
class Difference(Operation):
    ...
    def membership_equivalence(self, element, assumptions=USE_DEFAULTS):
        ...
        return difference_def.instantiate({x:element,A:self.operands[0], B:self.operands[1]}, assumptions=assumptions)
    ...
    def nonmembership_equivalence(self, element, assumptions=USE_DEFAULTS):
        ...
        return nonmembership_equiv.instantiate({x:element, A:self.operands[0], B:self.operands[1]})
    ...
    def deduce_membership(self, element, assumptions=USE_DEFAULTS):
        ...
        return membership_folding.instantiate({x:element, A:self.operands[0], B:self.operands[1]}, assumptions=assumptions)
    ...
    def deduce_nonmembership(self, element, assumptions=USE_DEFAULTS):
        ...
        return nonmembership_folding.instantiate({x:element, A:self.operands[0], B:self.operands[1]}, assumptions=assumptions)

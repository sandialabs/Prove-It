...
class Not(Operation):
    ...
    _operator_ = Literal(string_format='not', latex_format=r'\lnot', theory=__file__)
    ...
    def side_effects(self, judgment):
        ...
        if hasattr(self.operand, 'negation_side_effects'):
            ...
            for neg_side_effect in self.operand.negation_side_effects(judgment):
    ...
    def evaluation(self, assumptions=USE_DEFAULTS, *, automation=True,
        ...
        if self.operand.proven(assumptions) and self.operand != TRUE:
            ...
            return falsified_negation_intro.instantiate({A:self.operand}, assumptions=assumptions)
    ...
    def substitute_in_false(self, lambda_map, assumptions=USE_DEFAULTS):
        ...
        return substitute_in_false.instantiate({x:self.operand, P:Plambda}, assumptions=assumptions)            
    ...
    def substitute_falsehood(self, lambda_map, assumptions=USE_DEFAULTS):
        ...
        Plambda = Equals._lambda_expr(lambda_map, self.operand)
        return substitute_falsehood.instantiate({x:self.operand, P:Plambda}, assumptions=assumptions)            
    ...
    def deduce_in_bool(self, assumptions=USE_DEFAULTS):
        ...
        if isinstance(self.operand, Not):
            return double_neg_closure.instantiate({A:self.operand.operand}, assumptions=assumptions)
    ...
    def deduce_operand_in_bool(self, assumptions=USE_DEFAULTS):
        ...
        return operand_is_bool.instantiate({A:self.operand}, assumptions=assumptions)
    ...
    def equate_negated_to_false(self, assumptions=USE_DEFAULTS):
        ...
        return negation_elim.instantiate({A:self.operand}, assumptions=assumptions)
    ...
    def derive_untrue(self, assumptions=USE_DEFAULTS):
        ...
        return untrue_from_negation.instantiate({A:self.operand}, assumptions=assumptions)    
    ...
    def double_negation_equivalence(self, assumptions=USE_DEFAULTS):
        ...
        if isinstance(self.operand, Not):
            return double_negation_equiv.instantiate({A:self.operand.operand}, assumptions=assumptions)
        raise ValueError("double_negation_equivalence does not apply to " + str(self) + " which is not of the form not(not(A))")
    ...
    def derive_via_double_negation(self, assumptions=USE_DEFAULTS):
        ...
        if isinstance(self.operand, Not):
            return double_negation_elim.instantiate({A:self.operand.operand}, assumptions=assumptions)
        raise ValueError("derive_via_double_negation does not apply to " + str(self) + " which is not of the form not(not(A))")
    ...
    def conclude_via_double_negation(self, assumptions=USE_DEFAULTS):
        ...
        if isinstance(self.operand, Not):
            ...
            return double_negation_intro.instantiate({A:stmt}, assumptions=assumptions)
    ...
    def conclude_via_falsified_negation(self, assumptions=USE_DEFAULTS):
        ...
        return negation_intro.instantiate({A:self.operand}, assumptions=assumptions)                        
    ...
    def derive_contradiction(self, assumptions=USE_DEFAULTS):
        ...
        return negation_contradiction.instantiate({A:self.operand}, assumptions=assumptions)
    ...
    def deduce_double_negation_equiv(self, assumptions=USE_DEFAULTS):
        ...
        if isinstance(self.operand, Not):
            ...
            return double_negation_equiv.instantiate({A:Asub}, assumptions=assumptions)

...
class NumberRelation:
    ...
    def _update(self, relation, simplify, assumptions):
        if simplify:
            relation = relation.lhs.inner_expr().simplify(assumptions)
            relation = relation.rhs.inner_expr().simplify(assumptions)
        self.relation = relation
        return relation
    
    def mult_left(self, multiplier, *, simplify=True, assumptions=USE_DEFAULTS):
    ...
    def mult_right(self, multiplier, *, simplify=True, assumptions=USE_DEFAULTS):
        from proveit.number.multiplication._theorems_ import (
    ...
    def divide(self, divisor, *, simplify=True, assumptions=USE_DEFAULTS):
    ...
    def add_left(self, addend, *, simplify=True, assumptions=USE_DEFAULTS):
    ...
    def add_right(self, addend, *, simplify=True, assumptions=USE_DEFAULTS):
        from proveit.number.addition._theorems_ import (
    ...
    def exponentiate(self, exponent, *, simplify=True, assumptions=USE_DEFAULTS):
    ...
    def square(self, *, simplify=True, assumptions=USE_DEFAULTS):
        return self.exponentiate(two, assumptions)

    def square_root(self, *, simplify=True, assumptions=USE_DEFAULTS):

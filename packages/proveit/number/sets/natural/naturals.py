...
class NaturalPosSet(NumberSet):
    ...
    def deduce_member_non_zero(self, member, assumptions=USE_DEFAULTS):
        from proveit.number.sets.integer._theorems_ import nonZeroIfInNaturalsPos
...
if proveit.defaults.automation:
    ...
    from proveit.number.sets.integer._theorems_ import natsPosInNats, natsInInts, natsPosInInts

...
class IntegerSet(NumberSet):
    ...
    def deduce_member_in_rational(self, member, assumptions=USE_DEFAULTS):
        ...
        return int_within_rational.derive_superset_membership(member, assumptions)
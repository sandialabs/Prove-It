...
class IntervalOO(RealInterval):
    ...
    def __init__(self,lower_bound,upper_bound):
        RealInterval.__init__(self,IntervalOO._operator_,lower_bound,upper_bound)
    ...
    def deduce_right_relaxed_membership(self, member, assumptions=USE_DEFAULTS):
...
class IntervalOC(RealInterval):
    ...
    def __init__(self,lower_bound,upper_bound):
        RealInterval.__init__(self,IntervalOC._operator_,lower_bound,upper_bound)
...
class IntervalCO(RealInterval):
    ...
    def __init__(self,lower_bound,upper_bound):
        RealInterval.__init__(self,IntervalCO._operator_,lower_bound,upper_bound)
...
class IntervalCC(RealInterval):
    ...
    def __init__(self,lower_bound,upper_bound):
        RealInterval.__init__(self,IntervalCC._operator_,lower_bound,upper_bound)

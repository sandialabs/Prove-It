...
class DecimalSequence(NumeralSequence):
    ...
    def deduce_in_natural(self, assumptions=USE_DEFAULTS):
        ...
        return deci_sequence_is_nat.instantiate({n: self.operands.length(assumptions),
    ...
    def deduce_in_natural_pos(self, assumptions=USE_DEFAULTS):
        ...
        return deci_sequence_is_nat_pos.instantiate({n: self.operands.length(assumptions),
                                                         a: self.digits}, assumptions=assumptions)
    ...
    def num_add_eval(self, num2, assumptions=USE_DEFAULTS):
        ...
        return eq.inner_expr().rhs.operands[-1].evaluate(assumptions=assumptions)
...
class DigitSet(NumberSet):
    ...
    def deduce_member_lower_bound(self, member, assumptions=USE_DEFAULTS):
        ...
        return digits_lower_bound.instantiate({n: member}, assumptions=assumptions)

    def deduce_member_upper_bound(self, member, assumptions=USE_DEFAULTS):
        from ._theorems_ import digits_upper_bound
        return digits_upper_bound.instantiate({n: member}, assumptions=assumptions)
...
class DeciMembership(NumberMembership):
    ...
    def conclude(self, assumptions=USE_DEFAULTS):
        ...
        try:
            ...
            return n_in_digits.instantiate({n: self.element}, assumptions=assumptions)

...
from proveit.numbers.numeral.numeral import NumeralSequence, Numeral
from proveit.numbers.numeral._common_ import zero, one, two, three, four, five, six, seven, eight, nine
...
class DecimalSequence(NumeralSequence):
    ...
    def deduceInNatural(self, assumptions=USE_DEFAULTS):
        ...
        #     from proveit.numbers.numeral.deci._theorems_ import nat1, nat2, nat3, nat4, nat5, nat6, nat7, nat8, nat9
    ...
    def deduceInNaturalPos(self, assumptions=USE_DEFAULTS):
        ...
        #     from proveit.numbers.numeral.deci._theorems_ import posnat1, posnat2, posnat3, posnat4, posnat5
        #     from proveit.numbers.numeral.deci._theorems_ import posnat6, posnat7, posnat8, posnat9
    ...
    def reduce_exprRange(self, assumptions=USE_DEFAULTS):
        ...
        from proveit.numbers.numeral.deci._theorems_ import deci_sequence_reduction_ER
...
class DeciMembership(NumberMembership):
    ...
    def conclude(self, assumptions=USE_DEFAULTS):
        ...
        #     thm = proveit.numbers.numeral.deci._theorems_ \

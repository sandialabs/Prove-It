...
# transferred by wdc 3/11/2020
mod_in_interval = Forall((a, b), InSet(Mod(a, b), Interval(zero, Sub(b, one))), domain=Integer)
mod_in_interval
...
# transferred by wdc 3/11/2020
abs_nonzero_closure = Forall([a], InSet(Abs(a), RealPos), domain=Complex, conditions=[NotEquals(a, zero)])
abs_nonzero_closure

# transferred by wdc 3/11/2020
mod_in_interval_c_o = Forall((a, b), InSet(Mod(a, b), IntervalCO(zero, b)), domain=Real)
mod_in_interval_c_o
...
# transferred by wdc 3/11/2020
abs_not_eq_zero = Forall([a], NotEquals(Abs(a), zero), domain=Complex, conditions=[NotEquals(a, zero)])
abs_not_eq_zero
...
# transferred by wdc 3/11/2020
mod_abs_scaled = Forall((a, b, c), Equals(Mult(a, ModAbs(b, c)), ModAbs(Mult(a, b), Mult(a, c))), domain=Real)
mod_abs_scaled

# transferred by wdc 3/11/2020
mod_abs_subtract_cancel = Forall((a, b, c), LessThanEquals(ModAbs(Sub(Mod(Add(b, a), c), b), c), 
                                                        Abs(a)),
                              domain=Real)
mod_abs_subtract_cancel

# transferred by wdc 3/11/2020
full_modular_range_equiv = Forall((N, a, b), 
...
# transferred by wdc 3/11/2020
full_modular_range_equiv_left_shift = Forall((N, a, b, c), 
...
# transferred by wdc 3/11/2020
full_modular_range_equiv_right_shift = Forall((N, a, b, c), 

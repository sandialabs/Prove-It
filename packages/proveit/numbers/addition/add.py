...
class Add(Operation):
    ...
    def deduceNegation(self, rhs, assumptions=USE_DEFAULTS):
        ...
        '''
        from proveit.numbers.addition.subtraction._theorems_ import negatedAdd
        if len(self.terms) != 2:
    ...
    def deduceSubtraction(self, rhs, assumptions=USE_DEFAULTS):
        ...
        '''
        from proveit.numbers.addition.subtraction._theorems_ import subtractFromAdd
        if len(self.terms) != 2:
    ...
    def deduceReversedSubtraction(self, rhs, assumptions=USE_DEFAULTS):
        ...
        '''
        from proveit.numbers.addition.subtraction._theorems_ import subtractFromAddReversed
        if len(self.terms) != 2:
        ...
        for _i, operand in enumerate(expr.operands):
            if isinstance(operand, Add):
                ...
                if isinstance(expr.operands[_i].operands[0], Add) and len(expr.operands[_i].operands[0].operands) == 1:
                    from proveit.numbers.addition._axioms_ import singleAdd
    ...
    def doReducedEvaluation(self, assumptions=USE_DEFAULTS, **kwargs):
        ...
        from proveit.numbers import Neg, isLiteralInt
    ...
    def subtractionFolding(self, termIdx=None, assumptions=frozenset()):
        ...
        '''
        from proveit.numbers import Neg
        from proveit.numbers.addition.subtraction.theorems import addNegAsSubtract
        if termIdx is None:
    ...
    def deduceInNaturalPosDirectly(self, assumptions=frozenset(), ruledOutSets=frozenset(), dontTryPos=False, dontTryNeg=False):
        ...
        '''
        from proveit.numbers.numberSets import DeduceInNumberSetException, deducePositive
    ...
    def factorization(self, theFactor, pull="left", groupFactor=True, assumptions=USE_DEFAULTS):
        ...
        '''
        from proveit.numbers.multiplication._theorems_ import distributeThroughSum
...
def const_shift_decomposition(idx):
    ...
    '''
    from proveit.numbers import zero, isLiteralInt
    if isLiteralInt(idx):

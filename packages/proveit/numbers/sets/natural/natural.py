...
class NaturalSet(NumberSet):
    ...
    def deduceMemberLowerBound(self, member, assumptions=USE_DEFAULTS):
        from proveit.numbers.sets.natural._theorems_ import naturalLowerBound
    ...
    def deduceMembershipInBool(self, member, assumptions=USE_DEFAULTS):
        from proveit.numbers.sets.natural._theorems_ import xInNatInBool
    ...
    def deduceMemberInInt(self, member, assumptions=USE_DEFAULTS):
        from proveit.numbers.sets.integer._theorems_ import natInInt
...
class NaturalPosSet(NumberSet):
    ...
    def deduceMemberLowerBound(self, member, assumptions=USE_DEFAULTS):
        from proveit.numbers.sets.natural._theorems_ import naturalPosLowerBound
    ...
    def deduceMembershipInBool(self, member, assumptions=USE_DEFAULTS):
        from proveit.numbers.sets.natural._theorems_ import xInNatPosInBool
        from proveit._common_ import x
    ...
    def deduceMemberInNat(self, member, assumptions=USE_DEFAULTS):
        from proveit.numbers.sets.natural._theorems_ import natPosInNat
    ...
    def deduce_member_non_zero(self, member, assumptions=USE_DEFAULTS):
        from proveit.numbers.sets.natural._theorems_ import nonZeroIfInNaturalPos
...
if proveit.defaults.automation:
    ...
    from proveit.numbers.sets.natural._theorems_ import natPosInNat
    from proveit.numbers.sets.integer._theorems_ import natInInt, natPosInInt

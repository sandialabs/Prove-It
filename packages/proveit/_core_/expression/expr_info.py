...
class ExpressionInfo:
    ...
    def _repr_html_(self):
        from .composite import ExprTuple, ExprTensor, NamedExprs, Indexed, Iter
        from .operation import Operation
        from .lambda_expr import Lambda
        ...
        for k, expr in enumerate(enumerated_expressions):
            ...
            if self.show_details and expr.__class__ not in (Variable, Literal, Operation, Lambda, Indexed, NamedExprs, ExprTuple, ExprTensor, Indexed, Iter):

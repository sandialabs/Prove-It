...
def clean_cell(o):
    ...
    if 'outputs' in o:
        o['outputs'] = []
    o['metadata'] = {k: o['metadata'][k]
                     for k in o['metadata'].keys() if k in cell_metadata_keep}
    return o
...
def clean_nb(input_stream):
    ...
    # ============================================================ #
    # Adding this to avoid having to save changes in kernelspec's
    # "display_name"
